...
public class CubeGLSurfaceView extends GLSurfaceView {
    ...
    private class CubeRenderer implements Renderer {
        ...
        public int CreateCubeTexture() {
            ...
            byte[] cubePixels0 = { 127, 0, 0 }; // Face 0 - Red
            byte[] cubePixels1 = { 0, 127, 0 }; // Face 1 - Green
            byte[] cubePixels2 = { 0, 0, 127 }; // Face 2 - Blue
            byte[] cubePixels3 = { 127, 127, 0 }; // Face 3 - Yellow
            byte[] cubePixels4 = { 127, 0, 127 };  // Face 4 - Purple
            byte[] cubePixels5 = { 127, 127, 127 }; // Face 5 - White
